...
func (r *Response[T]) ErrorInfo() *ErrorInfo {
	return r.Error
}

func (r *Response[T]) Invalid(e *ErrorInfo) *Response[T] {
	r.Ok = false
...
func (r *Response[T]) SetErrorMessage(code string, message string, args ...interface{}) *Response[T] {
	...
	r.Error = NewErrorInfo("error", msg)
...
func (r *ErrorResponse) ErrorInfo() *ErrorInfo {
	return r.Error
}
...
func NewTargetedErrorResponse(target string, code string, message string) *ErrorResponse {
	return &ErrorResponse{
		Ok:    false,
		Error: &ErrorInfo{Code: code, Message: message, Target: &target},
	}
}
...
func (r *PagedResponse[T]) ErrorInfo() *ErrorInfo {
	return r.Error
}
